...
public abstract class SubjectDao {
	...
	// 과목이름으로 조회해서 결과를 return method
	public abstract List<SubjectDTO> findByName(String sb_name); // 호환성을 위해 PK를 제외한 나머지는 List로 return하는게 좋음
	public abstract List<SubjectDTO> findByPro(String sb_pro);
	
	// DTO에 과목 데이터를 저장하여 method에 주입한 후
	// insert를 수행
	...
	// 매개변수와 형, 값이 같다.
	public abstract int delete(String sb_num); // PK로 삭제하기 때문에 findById와 같은 type
